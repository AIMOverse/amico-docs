...
- **Agent DID System**
  ...
  - For more technical details and design philosophies regarding Agent DID, refers to [AiMoverse Docs/Agent DID](/docs/technical-deepdive/agent-did).
...
- **Agent-of-Things (AOT)**
  - Amico supports Agent-of-Things (AOT), which allows agents to interact with physical devices, such as sensors, actuators, and other devices remotely, even what devices are not running Amico.
